...
However, four authors are now contributing articles and one co-author is stepping up and reviewing almost every article and taking over the main authorship on half a dozen.

C++ is still the main topic, with Python being the language used in 6 articles.
Java no longer had a dedicated article, but it was mentioned in TotW/60.
