...
Long story short, last Tuesday, I gave a public presentation for our Prague office about compile-time programming in C++.
...
However, the point is taken. I should do better, especially before giving presentations about
...
The pformat library has very high compilation times. The test builds 100 translation units, each printing
5 formats with a mix of integers and strings with 1 to 5 parameters each. That is not
a lot of functionality.
The compilation times of some other libraries are surprisingly high, too.
